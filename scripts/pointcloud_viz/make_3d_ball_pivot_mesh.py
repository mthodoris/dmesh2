...
in_path = "data/3d/umbrella_pointcloud.ply"
...
mesh_path = os.path.join(out_dir, "umbrella_ball_pivot_mesh.ply")
...
fig.tight_layout()
render_path = os.path.join(out_dir, "umbrella_ball_pivot_mesh_render.png")
