...
OUT_DIR = "data/3d/garden_scene_voxel_mesh_3d"
...
# bin index per point per axis (clip last edge into the last bin)
...
if all_mesh_verts:
    ...
    combined_path = os.path.join(OUT_DIR, "garden_scene_voxel_combined_mesh.ply")
    ...
    fig.tight_layout()
    render_path = os.path.join(OUT_DIR, "garden_scene_voxel_combined_render.png")
