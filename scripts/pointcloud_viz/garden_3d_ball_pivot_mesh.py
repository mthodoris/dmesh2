...
in_path = "data/3d/garden_scene_pointcloud.ply"
out_dir = "data/3d/garden_scene_mesh_3d"
...
# --- estimate + consistently orient normals (required for ball pivoting) ---
...
mesh_path = os.path.join(out_dir, "garden_scene_ball_pivot_mesh.ply")
o3d.io.write_triangle_mesh(mesh_path, mesh)
print(f"Saved mesh to {mesh_path}")

# --- visualization: input points vs reconstructed mesh ---
...
def set_equal_3d_limits(ax):
    ...
    ax.set_zlim(center[2] - radius * 0.3, center[2] + radius * 1.7)
...
fig.tight_layout()
render_path = os.path.join(out_dir, "garden_scene_ball_pivot_mesh_render.png")
